...
class _AlertsPageState extends State<AlertsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _alertButtonController = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 500),
    );
    _alertButtonController.repeat(reverse: true);
    
    // Initialize controller
    controller = Get.put(AlertsController());
    controller.setAnimationController(_alertButtonController);
  }

  @override
  void dispose() {
    _alertButtonController.dispose();
    super.dispose();
  }
            ...
            child: Row(
              ...
              children: [
                ...
                Obx(() => Container(
                  ...
                  child: Text(
                    '${controller.alerts.length} ${controller.alerts.length == 1 ? "Alert" : "Alerts"}',
                    style: TextStyle(
                      color: const Color(0xFFFF4D79),
                      fontWeight: FontWeight.bold,
                      fontSize: 12.sp,
